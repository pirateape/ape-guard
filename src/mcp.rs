...
mod tests {
    ...
    fn test_list_tools_response() {
        ...
        let tools = resp["result"]["tools"]
            .as_array()
            .expect("mcp test: tools should be an array");
    ...
    fn test_resource_list() {
        ...
        let resources = resp["result"]["resources"]
            .as_array()
            .expect("mcp test: resources should be an array");
        assert!(resources
            .iter()
    ...
    fn test_handle_resources_read_valid() {
        ...
        let result = tokio::runtime::Runtime::new()
            .expect("mcp test: failed to create tokio runtime")
            .block_on(handle_request(line));
        assert!(result.is_ok());
        let resp = result.expect("mcp test: request should succeed");
