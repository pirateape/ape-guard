...
type: Rust Method
title: new
resource: src/scanner/tls.rs#L15-L19
generated:
  by: okf-rs/0.4.0
relationships:
  called_by:
  ...
  - target: functions/src/orchestrate/run_scan
    resolved_by: rust-analyzer
    confidence: semantic
  - target: functions/src/scanner/tls/test_tls_scanner_name
    resolved_by: rust-analyzer
    confidence: semantic
  - target: functions/src/scanner/tls/test_tls_scanner_type
    resolved_by: rust-analyzer
    confidence: semantic
  - target: functions/src/scanner/tls/test_tls_scanner_installed
    resolved_by: rust-analyzer
    confidence: semantic
